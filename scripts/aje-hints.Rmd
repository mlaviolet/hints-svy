...
Like most surveys, nearly all variables in HINTS are categorical. Following the guidelines, for the purpose of presenting linear regression we treat `GeneralHealth` as a quantitative variable. Lower values correspond to better health.
...
```{r chisquare5_3}
svychisq(
  ~ AlcoholConditions_Cancer_uncertain + AlcoholConditions_LiverDisease_uncertain,
  hints5_3)
```
