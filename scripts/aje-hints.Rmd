...
HINTS data with supporting documentation, including analysis examples, are available to the public. Currently this material is available only for the most common propietary statistical software systems: SAS, SPSS, and Stata. This article aims to demonstrate that HINTS analysis can be conducted using the free, open-source environment R [@rcoreteam2021], and thus make these valuable data useful to analysts without access to expensive proprietary software.
