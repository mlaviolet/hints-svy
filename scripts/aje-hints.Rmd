...
All HINTS iterations were administered exclusively by mail, except for HINTS 5, Cycle 3, which included a pilot for online response. Respondents who were part of the pilot were randomly assigned to either of two options: a choice between responding via paper or online, or a choice between responding via paper or online with an additional \$10 incentive for those responding online. NCI strongly recommends that analysts first assess their variables of interest for differences among the three modes. For this purpose, NCI provides a set of 50 replicate weights for the combined sample and a set of 150 replicate weights for the grouped sample.

ADD CODE FOR SETTING UP SURVEY OBJECTS
